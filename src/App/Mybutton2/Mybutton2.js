...
import styles from './Mybutton2.module.scss';
...
const Mybutton = (props) => {
  ...
  return (
    <div className={styles.Mybutton} data-testid="Mybutton2" onClick={onclick} style={{ borderColor: props.color }}>
...
Mybutton.defaultProps = { color: 'tomato' };
